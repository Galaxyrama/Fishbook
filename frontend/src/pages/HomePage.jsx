        ...
        <div className='flex justify-center w-full pb-5 pt-20 px-2'>
          <div className='w-full max-w-3xl'>
            <div className='flex items-center gap-4 rounded-lg drop-shadow-xl py-6 bg-white px-4'>
              ...
              <button className='py-3 bg-btn rounded-xl text-white px-5 sm:text-xl
                cursor-pointer sm:pr-15 w-[670px] max-w-[670px] text-center'
                onClick={openModal}>What's swimming through your mind, {user}?</button>
            </div>
          </div>
        </div>

        <Post User="test" Img="images/post_sample.jpg" DateUpload={Date.now()} ProfilePic="images/fishBackground.jpg"/>
        <Post User={user} Img="images/Towa.jpg" DateUpload={Date.now() + 100000000} ProfilePic="images/fishBackground.jpg"/>
