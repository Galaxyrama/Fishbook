            ...
            <div className='content-center sm:flex'>
                <div className='flex justify-center min-h-screen items-center w-full font-montagu bg-background sm:mt-0'>
                    <div className='p-8'>
                        ...
                        <p className='mb-5 text-dark-blue font-semibold text-3xl'>Log in to your account</p>
                        <p className='mb-5 text-base text-light-blue'>Log in now with your account to see what others are up to!</p>
                        <form className='margin-auto mb-3' onSubmit={handleLogin}>
                            <div className="container">
                                ...
                                <label htmlFor="password" className='inline-block mt-6 mb-3 text-medium-blue'>Password</label>
                                <div className='relative'>
                            ...
                            <button type="submit" 
                                ...
                                p-4 rounded-2xl mt-4 mb-4 cursor-pointer'>Sign in</button>
                            ...
                            <div className='container flex text-dark-blue justify-center mt-1'>      
                                ...
                                <Link to="/register" className='underline font-semibold'>Create a new account</Link>
                            </div>
                        </form>
                    </div>
                </div>
